    ...
    <p>Pour vous inscrire en tant qu'administrateur afin d'avoir accés à toutes les fonctionnalités du site, veuillez me contacter : nadir.boudjerada@gmail.com</p>
        ...
        <?php echo form_open(); ?>
            <div class="form-group">
                ...
                <br>
                <br>
                <label for="us_mp"><b>Mot de passe</b></label><input type="password" class="form-control" name="us_mp" id="us_mp" value="<?=set_value('us_mp');?>" placeholder="Veuillez choisir un mot de passe de connexion de 8 caractères" > <!--formcontrol pour mettre la zone de saisie en dessous du titre du champs-->
                <?php echo form_error('us_mp'); // affiche l'erreur du champs concerné?>
                <br>
                <label for="us_mp2"><b>Confirmer mot de passe</b></label><input type="password" class="form-control" name="us_mp2" id="us_mp2" placeholder="Veuillez confirmer vôtre mot de passe de connexion" > <!--formcontrol pour mettre la zone de saisie en dessous du titre du champs-->
                <br>
